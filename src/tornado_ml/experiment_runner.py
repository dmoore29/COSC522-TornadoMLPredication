...
class ExperimentRunner:
    ...
    def _run_logistic_regression(self, split: DataSplit) -> ModelResult:
        ...
        X_train = preprocessor.fit_transform(split.X_train)  # fit only on train
        X_val = preprocessor.transform(split.X_val)           # transform only — no leakage
        ...
        logger.info("Evaluating Logistic Regression on validation set")
